...
psi = np.zeros_like(d) # variáveis adjuntas tem mesmo tamanho das variáveis de estado
...
print('derivative time: ', derivative_time, ' seconds')

relative_time = derivative_time / solution_time
